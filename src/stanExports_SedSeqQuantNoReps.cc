...
#include "stanExports_SedSeqQuantNoReps.h"

RCPP_MODULE(stan_fit4SedSeqQuantNoReps_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_SedSeqQuantNoReps")
